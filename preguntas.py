...
def pregunta_09():
    ...
    tbl1 = pd.read_csv("tbl1.tsv", sep="\t")
    tbl2 = pd.read_csv("tbl2.tsv", sep="\t")
    _c4 = tbl0["_c3"].str.split('-' ,expand= True)
    _c4.columns = ['year', 'month','day']
    _c4.year 
    tbl0['year'] = _c4.year
